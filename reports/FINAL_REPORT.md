...
- **Honest headline:** weighted F1 = **0.6528** under person-level Leave-One-Patient-Out (LOPO) with nested-CV per-class thresholds; raw-argmax shippable model = **0.6346**. Baseline single-encoder = 0.615. Label-shuffle null = 0.276 ± 0.042 → signal is real.
...
|---|---|---:|---:|---|
| **1** | **DINOv2-B + BiomedCLIP proba-avg + nested-CV thresholds** | **0.6528** | 0.4985 | ✓ red-team verified |
